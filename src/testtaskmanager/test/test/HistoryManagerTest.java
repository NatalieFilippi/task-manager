...
public class HistoryManagerTest {
    ...
    private final static Epic epic = new Epic("Test addNewEpic", "Test addNewEpic description");
    private final static Task task1 = new Task("Test 1 addNewTask", "Test 1 addNewTask description", TaskStatus.NEW);
    private final static Task task2 = new Task("Test 2 addNewTask", "Test 2 addNewTask description", TaskStatus.NEW);
    private final static Subtask s1 = new Subtask("Subtask test 1", "subtask test 1", TaskStatus.NEW, 2);
    private final static Subtask s2 = new Subtask("Subtask test 2", "subtask test 2", TaskStatus.NEW, 2);
